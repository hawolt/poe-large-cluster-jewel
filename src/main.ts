...
function renderNotablePane(kind: 'prefix' | 'suffix'): void {
  ...
  <div class="ni-main">
    ...
    <div class="ni-right">
      ${!isThisSlot && !isOtherSlot && inWindow ? '<span class="desired-tag">desired</span>' : !isThisSlot && !isOtherSlot && isVariant ? '<span class="variant-tag">2-notable variant</span>' : !isThisSlot && !isOtherSlot && undesired ? '<span class="undesired-tag">undesired</span>' : ''}
